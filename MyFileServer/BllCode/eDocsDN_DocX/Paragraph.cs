...
namespace eDocsDN_DocX
{
    ...
    public class Paragraph : InsertBeforeOrAfter
    {
        ...
        public Alignment Alignment
        {
            get
            {
                ...
                if (jc != null)
                {
                    ...
                    {
                        case "left": return eDocsDN_DocX.Alignment.left;
                        case "right": return eDocsDN_DocX.Alignment.right;
                        case "center": return eDocsDN_DocX.Alignment.center;
                        case "both": return eDocsDN_DocX.Alignment.both;
                    }
                }

                return eDocsDN_DocX.Alignment.left;
            }
            ...
            set
            {
                ...
                if (alignment != eDocsDN_DocX.Alignment.left)
                {
                    if (jc == null)
        ...
        public Paragraph UnderlineStyle(UnderlineStyle underlineStyle)
        {
            ...
            {
                case eDocsDN_DocX.UnderlineStyle.none: value = string.Empty; break;
                case eDocsDN_DocX.UnderlineStyle.singleLine: value = "single"; break;
                case eDocsDN_DocX.UnderlineStyle.doubleLine: value = "double"; break;
        ...
        public Paragraph CapsStyle(CapsStyle capsStyle)
        {
            switch (capsStyle)
            {
                case eDocsDN_DocX.CapsStyle.none:
                    break;
        ...
        public Paragraph Highlight(Highlight highlight)
        {
            switch (highlight)
            {
                case eDocsDN_DocX.Highlight.none:
                    break;
        ...
        public Paragraph Misc(Misc misc)
        {
            switch (misc)
            {
                case eDocsDN_DocX.Misc.none:
                    break;

                case eDocsDN_DocX.Misc.outlineShadow:
                    {
                ...
                case eDocsDN_DocX.Misc.engrave:
                    {
        ...
        public Paragraph StrikeThrough(StrikeThrough strikeThrough)
        {
            ...
            {
                case eDocsDN_DocX.StrikeThrough.strike: value = "strike"; break;
                case eDocsDN_DocX.StrikeThrough.doubleStrike: value = "dstrike"; break;
                default: return this;
            }
