...
namespace GetConInfo.WR_GetAppInfo {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="ClsGetAppInfoSoap", Namespace="http://tempuri.org/")]
    public partial class ClsGetAppInfo : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ClsGetAppInfo() {
            this.Url = global::GetConInfo.Properties.Settings.Default.GetConInfo_WR_GetAppInfo_ClsGetAppInfo;
        ...
        public string GetConnectionString(string szProductName, string szRegion, string szConnectionType, out string szErrorMsg) {
            object[] results = this.Invoke("GetConnectionString", new object[] {
                        szProductName,
                        szRegion,
                        szConnectionType});
            szErrorMsg = ((string)(results[1]));
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void GetConnectionStringAsync(string szProductName, string szRegion, string szConnectionType) {
            this.GetConnectionStringAsync(szProductName, szRegion, szConnectionType, null);
        }
        
        /// <remarks/>
        public void GetConnectionStringAsync(string szProductName, string szRegion, string szConnectionType, object userState) {
            ...
            this.InvokeAsync("GetConnectionString", new object[] {
                        szProductName,
                        szRegion,
                        szConnectionType}, this.GetConnectionStringOperationCompleted, userState);
        }
