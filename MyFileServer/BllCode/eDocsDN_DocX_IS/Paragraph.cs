...
namespace eDocsDN_DocX_IS
{
    ...
    public class Paragraph : InsertBeforeOrAfter
    {
        ...
        public Alignment Alignment
        {
            get
            {
                ...
                if (jc != null)
                {
                    ...
                    {
                        case "left": return eDocsDN_DocX_IS.Alignment.left;
                        case "right": return eDocsDN_DocX_IS.Alignment.right;
                        case "center": return eDocsDN_DocX_IS.Alignment.center;
                        case "both": return eDocsDN_DocX_IS.Alignment.both;
                    }
                }

                return eDocsDN_DocX_IS.Alignment.left;
            }
            ...
            set
            {
                ...
                if (alignment != eDocsDN_DocX_IS.Alignment.left)
                {
                    if (jc == null)
        ...
        public Paragraph UnderlineStyle(UnderlineStyle underlineStyle)
        {
            ...
            {
                case eDocsDN_DocX_IS.UnderlineStyle.none: value = string.Empty; break;
                case eDocsDN_DocX_IS.UnderlineStyle.singleLine: value = "single"; break;
                case eDocsDN_DocX_IS.UnderlineStyle.doubleLine: value = "double"; break;
        ...
        public Paragraph CapsStyle(CapsStyle capsStyle)
        {
            switch (capsStyle)
            {
                case eDocsDN_DocX_IS.CapsStyle.none:
                    break;
        ...
        public Paragraph Script(Script script)
        {
            switch (script)
            {
                case eDocsDN_DocX_IS.Script.none:
                    break;
        ...
        public Paragraph Highlight(Highlight highlight)
        {
            switch (highlight)
            {
                case eDocsDN_DocX_IS.Highlight.none:
                    break;
        ...
        public Paragraph Misc(Misc misc)
        {
            switch (misc)
            {
                case eDocsDN_DocX_IS.Misc.none:
                    break;

                case eDocsDN_DocX_IS.Misc.outlineShadow:
                    {
                ...
                case eDocsDN_DocX_IS.Misc.engrave:
                    {
        ...
        public Paragraph StrikeThrough(StrikeThrough strikeThrough)
        {
            ...
            {
                case eDocsDN_DocX_IS.StrikeThrough.strike: value = "strike"; break;
                case eDocsDN_DocX_IS.StrikeThrough.doubleStrike: value = "dstrike"; break;
                default: return this;
            }
